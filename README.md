...
> Status: foundation scaffold plus coordinator envelope, handle-materialization
> smoke and minimal Arrow identity export. The project has executable Rust
> crates, C ABI header, CLI fingerprinting/planning/materialization commands,
> design documents, rationale, roadmap, CI and contract tests.
